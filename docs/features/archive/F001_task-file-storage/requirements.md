...
| --- | --- | --- |
| F001-R1 | The system shall initialize a `.taskpilot/` workspace with `project.yaml`, `items/`, and `comments/` | must |
...
- **F001-R1:** Running `taskpilot init .` creates the required `.taskpilot/` tree and a minimal `project.yaml` without overwriting existing canonical files.
...
- **F001-R5:** Two comments created in the same second receive filenames like `2026-06-23T10-00-00Z.md` and `2026-06-23T10-00-00Z-2.md`.
