...
| --- | --- | --- | --- | --- |
| F001-T1 | Define `.taskpilot/` folder layout constants and path resolution helpers | F001-R1 | todo | — |
| F001-T2 | Implement `taskpilot init` workspace creation | F001-R1 | todo | F001-T1 |
