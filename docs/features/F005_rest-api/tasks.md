...
| F005-T8 | Write API integration tests using FastAPI `TestClient` covering all endpoints, 404 paths, 400 domain-validation errors, and 422 body-parse errors | F005-R2, F005-R3, F005-R4, F005-R5, F005-R8 | done | F005-T2, F005-T3, F005-T4, F005-T5 |
