...
- Add --version/-v flag to the Python CLI so it works without the npm wrapper (TP-123)
- Show linked item status ahead of its title in the Linked to section (TP-111)
