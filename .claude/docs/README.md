...
| `AGENTS.md` | Operational policy and capability routing | Always; loaded through the tool entrypoint |

This file is a lookup index, not an operational contract.
