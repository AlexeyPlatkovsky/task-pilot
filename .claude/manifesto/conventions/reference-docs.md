...
The project-standard location for generated AI reference docs is `.claude/docs`.
...
Do not move existing project docs into `.claude/docs` unless the user explicitly approves that structural refactor.
...
Every generated or reorganized `.claude/docs` tree must include `.claude/docs/README.md`.
