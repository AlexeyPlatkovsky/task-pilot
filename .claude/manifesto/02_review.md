...
Use `.claude/docs/project_specification.md` as the authoritative profile source for user role, recurring duties, capability triggers, AI tools, quality expectations, and local authority sources.
...
Compare the detected model against `.claude/docs/project_specification.md`.
...
- verify that shared skills use the project-standard format `.claude/skills/<skill_name>/SKILL.md`
