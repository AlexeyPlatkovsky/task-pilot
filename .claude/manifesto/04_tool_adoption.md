...
Use `.claude/docs/project_specification.md` to decide whether the tool's capabilities are relevant to the user's role, recurring duties, quality expectations, and project context.
