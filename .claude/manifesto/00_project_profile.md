...
Create or update `.claude/docs/project_specification.md`.
...
- existing `.claude/docs/project_specification.md`, if present
...
- state whether an existing `.claude/docs/project_specification.md` will change
...
Store the profile at `.claude/docs/project_specification.md`.
