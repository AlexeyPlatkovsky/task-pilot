...
Use `.claude/docs/project_specification.md` as the authoritative profile source for role, duties, quality expectations, and accepted assumptions.
...
- what `.claude/docs/project_specification.md` says the user does most often
