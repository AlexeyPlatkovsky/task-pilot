...
| `{{TESTS_ROOT}}` | Root directory of the test suite | `.claude/tests/` |
...
| `{{FIXTURES_DIR}}` | Shared fixtures directory | `.claude/tests/_shared/fixtures/` |
| `{{RESULTS_DIR}}` | Gitignored results directory | `.claude/tests/results/` |
